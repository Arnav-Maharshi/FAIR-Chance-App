...
def indexF(image, results, frame_width, frame_height): 
...
while cv2.waitKey(1) != 27:
    ...
    if results.multi_hand_landmarks:
        ...
        frame, accuracy = indexF(frame, results, frame_width, frame_height) 
        
           
    # Show the output with skeleton overlay
    cv2.imshow('FAIR Chance Straight IndexF Flexion Feedback (Grouped Angles)', frame)
